...
const TimeLocation = forwardRef(({ children }, ref) => {
  return (
    <section className="time-location bg-transparent w-full flex xl:flex-col xl:justify-center items-center justify-between text-white py-20 px-10 phone:py-10 leading-[30px] tracking-wide text-[20px] xl:!px-4">
      <Reveal
