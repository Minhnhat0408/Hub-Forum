...
function Speakers() {
  return (
    <div className="flex flex-col w-full text-white bg-black/60 h-fit xl-max:px-7 sm-max:!py-8 py-20 px-10 ">
      <Reveal
        hiddenX={-500}
      ...
      <div className="flex w-full flex-wrap">
        <div className="flex  flex-col flex-1 phone:w- phone:flex-auto h-full justify-center items-center m-4 xl:mb-10">
          ...
          >
            <h3 className=" font-nokia event-heading text-[20px] mb-2 phone:text-base">
              Phùng Danh Tài - LLMs
            </h3>
            <p className="mb-10 phone:text-sm">Technical Manager of FHN.TCS</p>
            <div
              className="tai w-[400px] phone:w-full phone:h-[40vw] h-[250px]"
              alt="ava"
            />
          </Tilt>
        </div>
        <div className="flex flex-col flex-1 h-full phone:w-full phone:flex-auto justify-center items-center m-4 ">
          ...
          >
            ...
            <p className="mb-10 phone:text-sm">
              Head of Marketing SEA at Bitget
            </p>
            <div
              className="son w-[400px] h-[250px] phone:w-full phone:h-[40vw]"
              alt="ava"
            />
          </Tilt>
        </div>
